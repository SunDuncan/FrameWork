...
class AliMessage
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = $GLOBALS['config']['aliyun']['access_key']; // AccessKeyId

        $accessKeySecret = $GLOBALS['config']['aliyun']['access_secret']; // AccessKeySecret
     ...
     * @return stdClass
     */
    public function sendMessage($phone, $sign, $template, $data) {
        ...
        $res = json_decode(json_encode($acsResponse), true);
        return $res;
    }
...
// $response = AliMessage::sendMessage();
// echo "发送短信(sendSms)接口返回的结果:\n";
// print_r($response);

// sleep(2);

// $response = AliMessage::sendBatchSms();
// echo "批量发送短信(sendBatchSms)接口返回的结果:\n";
// print_r($response);

// sleep(2);

// $response = AliMessage::querySendDetails();
